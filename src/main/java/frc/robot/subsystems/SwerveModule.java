...
public class SwerveModule {
  ...
  public SwerveModule(
    ...
    // resolution.
    m_driveEncoder.setDistancePerPulse(ModuleConstants.driveEncoderDistancePerPulse);
    ...
    // encoder resolution.
    m_turningEncoder.setDistancePerPulse(ModuleConstants.turningEncoderDistancePerPulse);
